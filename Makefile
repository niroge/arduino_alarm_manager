#############################################################################
# Makefile for building: erasmus
# Generated by qmake (3.1) (Qt 5.11.3)
# Project:  erasmus.pro
# Template: app
# Command: /usr/lib64/qt5/bin/qmake -o Makefile erasmus.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = erasmus1.0.0
DISTDIR = /home/robert/erasmus/.tmp/erasmus1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
Makefile: erasmus.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
